...
class DialogPageCubit extends Cubit<DialogPageState> {
  ...
  DialogPageCubit({@required this.repository, @required int index})
      : super(
          DialogPageState(
  ...
  void editPage(int index, PropertyPage page) {
    repository.dialogPages[index] = repository.dialogPages[index]
        .copyWith(icon: page.icon, title: page.title);
