...
class PreferencesAccess {
  ...
  void saveTheme(bool usingLightTheme) => _prefs.setBool('usingLightTheme', usingLightTheme);

  void saveRightToLeft(bool isRightToLeft) => _prefs.setBool('isRightToLeft', isRightToLeft);

  void saveDateCentered(bool isDateCentered) => _prefs.setBool('isDateCentered', isDateCentered);
