...
class SettingsCubit extends Cubit<SettingsState> {
  ...
  void reset() async {
    ...
    emit(state.copyWith(fontSizeIndex: 0, isRightToLeft: false, isDateCentered: false));
  }

  static double calculateSize(BuildContext context, double val1, double val2, double val3) {
