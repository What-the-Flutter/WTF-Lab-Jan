  ...
  Widget _summary() {
      ...
      return Align(
        ...
        child: Container(
          ...
          child: DropdownButton<String>(
            ...
            onChanged:
                BlocProvider.of<StatisticsCubit>(context).setSelectedTimeline,
          ),
        ),
      );
    }
    ...
    Widget _grid() {
      ...
      int _countDayPages() {
        ...
        return BlocProvider.of<StatisticsCubit>(context)
            ...
            .where((element) => element.creationTime
                .isAfter(DateTime(today.year, today.month, today.day, 0, 0)))
            .length;
      }
      ...
      int _countDayFavourites() {
        ...
        return BlocProvider.of<StatisticsCubit>(context)
            .state
            .events
            .where((element) => (element.creationTime.isAfter(
      ...
      int _countWeekPages() {
        ...
        return BlocProvider.of<StatisticsCubit>(context)
            ...
            .pages
            .where((element) => (element.creationTime.isAfter(
                    DateTime(today.year, today.month, 5, 0, 0)) &&
                element.creationTime
                    .isBefore(DateTime(today.year, today.month, 12, 0, 0))))
            .length;
      }

      int _countWeekLabels() {
        final today = DateTime.now();
        return BlocProvider.of<StatisticsCubit>(context)
            .state
            .labels
      ...
      int _countWeekFavourites() {
        ...
        return BlocProvider.of<StatisticsCubit>(context)
            ...
            .events
            .where((element) => (element.creationTime
                    .isAfter(DateTime(today.year, today.month, 5, 0, 0)) &&
                element.isFavourite &&
                element.creationTime
                    .isBefore(DateTime(today.year, today.month, 12, 0, 0))))
            .length;
      ...
      return GridView.count(
        ...
        crossAxisCount: 2,
        children:
            BlocProvider.of<StatisticsCubit>(context).state.selectedTimeline ==
                    'Today'
                ? [
                    _infoTile(_countDayPages(), 'Pages', Colors.lightBlue),
                    _infoTile(_countDayEvents(), 'Events', Colors.deepOrange),
                    _infoTile(_countDayLabels(), 'Labels', Colors.lightGreen),
                    _infoTile(
                        _countDayFavourites(), 'Favourites', Colors.pinkAccent),
                  ]
                : [
                    _infoTile(_countWeekPages(), 'Pages', Colors.lightBlue),
                    _infoTile(_countWeekEvents(), 'Events', Colors.deepOrange),
                    _infoTile(_countWeekLabels(), 'Labels', Colors.lightGreen),
                    _infoTile(
                        _countWeekFavourites(), 'Favourites', Colors.pinkAccent),
                  ],
      );
    }
    ...
    Widget _chart() {
      List<charts.Series<Statistics, String>> createTodayData() {
        ...
        int countLabels(int start) => BlocProvider.of<StatisticsCubit>(context)
            .state
            .labels
            .where((element) =>
                (element.creationTime.isAfter(
        ...
        int countFavourites(int start) => BlocProvider.of<StatisticsCubit>(
                context)
            .state
            .events
            .where((element) =>
      ...
      List<charts.Series<Statistics, String>> createWeekData() {
        ...
        int countPages(int start) => BlocProvider.of<StatisticsCubit>(context)
            ...
            .where((element) =>
                (element.creationTime
                    .isAfter(DateTime(today.year, today.month, start, 0, 0))) &&
                element.creationTime.isBefore(
                    DateTime(today.year, today.month, start + 1, 0, 0)))
            .length;
        ...
        int countFavourites(int start) =>
            BlocProvider.of<StatisticsCubit>(context)
                ...
                .where((element) =>
                    (element.isFavourite &&
                        element.creationTime.isAfter(
                            DateTime(today.year, today.month, start, 0, 0))) &&
                    element.creationTime.isBefore(
                        DateTime(today.year, today.month, start + 1, 0, 0)))
                .length;
